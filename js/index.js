...
const moviesOriginalList = [
  ...
  function searchByTitle(searchTerm) {
    ...
    // search by doing lower case of title on both sides and trimming the search term
  ...
  function searchByGenre(searchTerm) {
    ...
    // search by doing lower case of genre on both sides and trimming the search term
